...
language_codes: ["eng_Latn","swe_Latn","deu_Latn","spa_Latn","fra_Latn","pol_Latn"]
languages: "en,sv,de,fr,es,pl"
purpose: "Megatron-ready 512k/1M/2M continuation data for superlong context extension"
source_type: "Public Hugging Face Megatron artifact"
priority: "P2 — superlong research and extension runs"
curator: "Birger / long-context team"
license_access: "Public and ungated; license is `other`, with source-specific upstream restrictions"
public_location: "https://huggingface.co/datasets/birgermoell/oellm-longctx-tokenized-superlong-512k-1m-2m-v2"
lumi_location: ""
data_format: "Megatron .bin/.idx (openeuro-longctx-megatron-v1)"
compression: "None recorded"
statistics: {"bytes":5838868212,"documents":null,"segments":1248,"characters":null,"tokens":null}
last_verified: "2026-08-18 through the Hugging Face page, API, and public manifests"
confidence: "High"
source_sheet_row: 84
---
...
> **Recorded languages:** en,sv,de,fr,es,pl
...
The artifact manifest provides exact payload bytes and packed-example count. The approximately 1.197B source-side token figure remains an estimate, so the normalized token field stays unset until it is reproduced with a pinned tokenizer.

| Measure | Value |
| --- | ---: |
| Bytes | 5,838,868,212 |
| Documents | — |
| Segments | 1,248 packed examples |
| Characters | — |
| Tokens | — |
| Data format | Megatron `.bin`/`.idx` (`openeuro-longctx-megatron-v1`) |
| Compression | None recorded |
...
| License and access | Public and ungated; license is `other`, with source-specific upstream restrictions |
...
Recorded coverage: en,sv,de,fr,es,pl
...
- **Public or upstream:** [public or upstream](<https://huggingface.co/datasets/birgermoell/oellm-longctx-tokenized-superlong-512k-1m-2m-v2>)
- **LUMI or project artifact:** Not recorded
- **Source register:** [Data register row 84](<https://docs.google.com/spreadsheets/d/1hFFDRk_JdjbQCCv3zsemKulSnMyk_fBQIfKPSzSaP9M/edit#gid=1339797209&range=A84:Q84>)
...
Public and ungated; license is `other`, with source-specific upstream restrictions
