...
- **Public or upstream:** [public or upstream](<https://huggingface.co/datasets/nvidia/Llama-Nemotron-Post-Training-Dataset>)
- **LUMI or project artifact:** `/scratch/project_462000963/datasets/posttraining_data/Llama-Nemotron-Post-Training-Dataset/SFT-math-sample-100k.jsonl`
- **Source register:** [Data register row 25](<https://docs.google.com/spreadsheets/d/1hFFDRk_JdjbQCCv3zsemKulSnMyk_fBQIfKPSzSaP9M/edit#gid=1339797209&range=A25:Q25>)
