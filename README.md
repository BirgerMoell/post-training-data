...
| **RLVR / GRPO data** | [EU24 procedural math](birgermoell-oellm-math-rlvr/0.1.0/README.md); [DAPO Math 17k](open-r1-dapo-math-17k-processed/0.1.0/README.md); [multilingual reasoning signal](oellm-multilingual-reasoning-signal/0.1.0/README.md); [procedural Python](birgermoell-oellm-code-rlvr/0.1.0/README.md); [GSM/MATH/IF constraints](allenai-rlvr-gsm-math-if-mixed-constraints/0.0.0/README.md); [EU tool-use v1](birgermoell-oellm-eu-tooluse-v1/0.0.0/README.md); [audited human prompts](birgermoell-oellm-eu-human-benchmarks-grpo/0.1.0/README.md) | EU24/34-language procedural reasoning; English hard math/code/tools; Finnish constraints; 28-language opt-in human prompts | **Runnable/staged:** shared LUMI releases plus `oellm-rlvr` TMAX, verl, and SkyRL/Harbor paths; per-checkpoint verifier qualification still applies |
