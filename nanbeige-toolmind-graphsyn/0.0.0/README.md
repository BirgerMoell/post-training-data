---
name: "Nanbeige/ToolMind — GraphSyn"
slug: "nanbeige-toolmind-graphsyn"
version: "0.0.0"
catalogue_status: "P"
...
purpose: "Graph-synthetic tool use"
source_type: "HF dataset"
priority: "P2"
curator: "T4.6 function-calling"
license_access: "Verify card"
public_location: "https://huggingface.co/datasets/Nanbeige/ToolMind"
lumi_location: ""
data_format: null
compression: null
...
Graph-synthetic tool use

## <a id="sources">Data Sources</a>

- **Public or upstream:** [source](<https://huggingface.co/datasets/Nanbeige/ToolMind>)
- **LUMI or other artifact:** Not recorded
- **Upstream / parent:** ToolMind GraphSyn
- **Evidence:** [evidence](<https://github.com/OpenEuroLLM/Taskboard/issues/220>)
- **Seed inventory:** [Data tab, row 74](<https://docs.google.com/spreadsheets/d/1hFFDRk_JdjbQCCv3zsemKulSnMyk_fBQIfKPSzSaP9M/edit#gid=1339797209&range=A74:Q74>)
...
- **Public or upstream:** [public or upstream](<https://huggingface.co/datasets/Nanbeige/ToolMind>)
- **LUMI or project artifact:** Not recorded
- **Source register:** [Data register row 74](<https://docs.google.com/spreadsheets/d/1hFFDRk_JdjbQCCv3zsemKulSnMyk_fBQIfKPSzSaP9M/edit#gid=1339797209&range=A74:Q74>)
