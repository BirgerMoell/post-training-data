...
priority: "P1"
curator: "Birger / T4.6"
license_access: "Public; inspect components"
...
| License and access | Public; inspect components |
...
- **Public or upstream:** [public or upstream](<https://huggingface.co/datasets/allenai/tulu-3-sft-mixture>)
- **LUMI or project artifact:** `/scratch/project_465002530/users/bmoell/posttrain-data/allenai__tulu-3-sft-mixture`
- **Source register:** [Data register row 7](<https://docs.google.com/spreadsheets/d/1hFFDRk_JdjbQCCv3zsemKulSnMyk_fBQIfKPSzSaP9M/edit#gid=1339797209&range=A7:Q7>)
